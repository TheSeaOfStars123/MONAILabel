python sample-apps/radiology/main.py -s /home/yczhao/Desktop/MONAILabel_datasets/myTask01_Breast -t train -m deepedit
...
-s
D:\Desktop\MONAILabel_datasets1\myTask03_Breast
-t
train
-m
segmentation_breast